...
function buildCharts() {
  ...
  const gridColor = "rgba(52, 164, 234, 0.10)";
  const slate = "#8ea4bf";
  const amber = "#34a4ea";
  const sage = "#63b8ef";
  const rose = "#1d8fd8";
  ...
  createChart("preview-mini-chart", {
    ...
    data: {
      ...
      datasets: [{
        ...
        borderColor: amber,
        backgroundColor: "rgba(52, 164, 234, 0.12)",
        fill: true,
        tension: 0.38,
        pointRadius: 0,
        borderWidth: 3,
      ...
      datasets: [
        {
          ...
          data: [5, 8, 7, 10, 12, 9],
          borderColor: amber,
          backgroundColor: "rgba(52, 164, 234, 0.14)",
          fill: true,
          tension: 0.35,
          pointRadius: 3,
        ...
        },
        {
          ...
          data: [1, 2, 2, 3, 5, 4],
          borderColor: sage,
          backgroundColor: "rgba(99, 184, 239, 0.14)",
          fill: true,
          tension: 0.35,
          pointRadius: 3,
  ...
  createChart("analysis-profile-chart", {
    ...
    data: {
      ...
      datasets: [{
        data: [86, 78, 74, 72, 63],
        borderColor: amber,
        backgroundColor: "rgba(52, 164, 234, 0.16)",
        pointBackgroundColor: amber,
  ...
  createChart("analysis-driver-chart", {
    ...
    data: {
      ...
      datasets: [{
        ...
        backgroundColor: [rose, amber, "#7bc4f1", slate],
        borderRadius: 8,
        barThickness: 18,
      }],
    },
